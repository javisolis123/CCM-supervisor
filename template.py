                                                ...
                                                <tr>
                                                  <td valign="top">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                      <tbody>
                                                        <tr>
                                                          <td valign="top" width="60"><img src="https://1.bp.blogspot.com/-cw33MROX4As/Wcu8H_YcJeI/AAAAAAAAABc/_tzAikQ1GEcVQeeZMn60BDwJL6IF8SPHACK4BGAYYCw/s400/comteco.png"
                                                              alt="Logo" title="Logo" width="60" height="60"
                                                              data-max-width="100"></td>
                                                            ...
                                                            <div class='contentEditableContainer contentTextEditable'>
                                                              <div class='contentEditable'
                                                                ...
                                                                <h1 class='big'><a target='_blank'
                                                                    ...
                                                                    style='color:#444444'>COMTECO R.L.</a></h1>
                                                              </div>
                                                            </div>
                                                          </td>
                                                        </tr>
                                        ...
                                        <tr>
                                          <td valign="top" width="580">
                                            <div class='contentEditableContainer contentImageEditable'>
                                              <div class='contentEditable' style="text-align: center;"><img
                                                  class="banner" src="https://www.comteco.com.bo/img/upload/prensas/0avMGy.png" alt="Logo" title="Logo"
                                                  width="580" height="221" border="0"></div>
                                            </div>
                                          </td>
                                        </tr>
                                      </tbody>
                                  ...
                                  <div class="movableContent"
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tbody>
                                        ...
                                        <tr>
                                          <td
                                            style="border: 1px solid #EEEEEE; border-radius:6px;-moz-border-radius:6px;-webkit-border-radius:6px">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                              <tbody>
                                                <tr>
                                                        ...
                                                        <td>
                                                          <div class='contentEditableContainer contentTextEditable'>
                                                            <div class='contentEditable' style='text-align: center;'>
                                                              <h2 style="font-size: 20px;">ALERTAS EN EL SISTEMA: </h2>
                                                              <br>
                                                              <p> 
                                                              """
html2 = """
